...
def next_id(t = None):
    ...
    :return: as 50-char string
    '''
    if t is None:
        t = time.time()
    # prefixed and suffixes using 0 to filled
...
def create_engine(user, password, database, host = '127.0.0.1', port = 3306, **kwargs):
    ...
    if engine is not None:
        raise DBError('Engine is alreadly initialized.')
...
class _Connectionctx(object):
    '''
    _Connection object that can open and close connection context. _Connectionctx object can be nested and only
